import { type VueLanguagePlugin } from '@vue/language-core/lib/types';
export * from '@vue/language-core/lib/plugins/shared';
export declare function getBasePlugins(pluginContext: Parameters<VueLanguagePlugin>[0]): {
    ...
    getEmbeddedCodes?(fileName: string, sfc: import("@vue/language-core/lib/types").Sfc): {
        id: string;
        lang: string;
    }[];
    resolveEmbeddedCode?(fileName: string, sfc: import("@vue/language-core/lib/types").Sfc, embeddedFile: import("@vue/language-core/lib/types").VueEmbeddedCode): void;
}[];
