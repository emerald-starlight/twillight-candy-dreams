...
export const options = resolveOptions({
  ...
  "dirs": {
    ...
    "servers": [],
    "root": [
      "/workspaces/twillight-candy-dreams/beaver-pro-landing"
    ],
    "src": [
      "",
